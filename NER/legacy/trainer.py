...
from utils import compute_metrics, get_labels, get_test_texts, show_report, MODEL_CLASSES, load_tokenizer
...
class Trainer(object):
    def __init__(self, args, train_dataset=None, dev_dataset=None, test_dataset=None):
        ...
        if args.write_pred:
            ...
            #0916 수정, 텍스트를 다른 곳에서 따로 가져오지 않게
    ...
    def evaluate(self, mode, step):
        ...
        # 0916 수정, 텍스트를 다른 곳에서 따로 가져오지 않게
        self.test_texts = [tokenizer.convert_ids_to_tokens(d[0][1:]) for d in dataset]
        #*******
        ...
        for i in range(out_label_ids.shape[0]):
            ...
            #print('비교 : ', out_label_list[i], preds_list[i])
